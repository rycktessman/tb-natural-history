...
chain_split <- as.numeric(Sys.getenv('SLURM_ARRAY_TASK_ID')) #chain/file to open and rows to run. set to 1 for testing
print(chain_split)
country <- as.character(Sys.getenv('country')) #Bangladesh, Cambodia, Nepal, Philippines, Vietnam
print(country)
