...
chain <- as.character(Sys.getenv('SLURM_ARRAY_TASK_ID')) #set to 1 if not running on a high-performance computing cluster
country <- as.character(Sys.getenv('country')) #Bangladesh, Cambodia, Nepal, Philippines, or Vietnam
print(chain)
print(country)
...
#versions of these arguments for testing (fewer params/faster)
#B <- 1000 
#B.re <- 1000
#number_k <- 5
#D <- 0
